...
import mx.conacyt.crip.crew.config.Constants;
import mx.conacyt.crip.crew.config.TestSecurityConfiguration;
import mx.conacyt.crip.crew.config.audit.AuditEventConverter;
import mx.conacyt.crip.crew.domain.PersistentAuditEvent;
...
import static mx.conacyt.crip.crew.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
