...
import AreaComponent from '@/entities/area/area.vue';
import AreaClass from '@/entities/area/area.component';
...
describe('Component Tests', () => {
  describe('Area Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      areaServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(areaServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(areaServiceStub.retrieve.callCount).toEqual(3);
