...
/**
 * REST controller for managing {@link mx.conacyt.crip.crew.domain.Area}.
 */
@RestController
@RequestMapping("/api")
public class AreaResource {
    ...
    public ResponseEntity<AreaDTO> updateArea(@Valid @RequestBody AreaDTO areaDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, areaDTO.getId()))
            .body(result);
    }
     ...
     */
    @GetMapping("/areas/{id}")
    public ResponseEntity<AreaDTO> getArea(@PathVariable String id) {
