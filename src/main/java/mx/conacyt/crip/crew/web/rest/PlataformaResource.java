...
/**
 * REST controller for managing {@link mx.conacyt.crip.crew.domain.Plataforma}.
 */
@RestController
@RequestMapping("/api")
public class PlataformaResource {
    ...
    public ResponseEntity<PlataformaDTO> updatePlataforma(@RequestBody PlataformaDTO plataformaDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, plataformaDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<List<PlataformaDTO>> getAllPlataformas(Pageable pageable) {
    ...
    public ResponseEntity<PlataformaDTO> getPlataforma(@PathVariable String id) {
    ...
    public ResponseEntity<Void> deletePlataforma(@PathVariable String id) {
