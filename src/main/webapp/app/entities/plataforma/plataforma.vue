      ...
      <table class="table table-striped">
        <thead>
          <tr>
            ...
            <th v-on:click="changeOrder('nombre')">
              <span v-text="$t('crewApp.plataforma.nombre')">Nombre</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'nombre'"></jhi-sort-indicator>
            </th>
            <th v-on:click="changeOrder('color')">
              <span v-text="$t('crewApp.plataforma.color')">Color</span>
            ...
            <th v-on:click="changeOrder('logo')">
              <span v-text="$t('crewApp.plataforma.logo')">Logo</span>
        ...
        <tbody>
          <tr v-for="plataforma in plataformas" :key="plataforma.id">
            ...
            <td><input type="color" disabled :value="plataforma.color" /></td>
            <td>
            ...
            <td class="text-right">
              <div class="btn-group">
                <router-link
                  :to="{ name: 'PlataformaView', params: { plataformaId: plataforma.id } }"
                  tag="button"
                ...
                <router-link
                  :to="{ name: 'PlataformaEdit', params: { plataformaId: plataforma.id } }"
                  tag="button"
                ...
                <b-button v-on:click="prepareRemove(plataforma)" variant="danger" class="btn btn-sm" v-b-modal.removeEntity>
