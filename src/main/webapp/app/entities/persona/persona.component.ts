...
export default class Persona extends mixins(JhiDataUtils, AlertMixin) {
  ...
  public removePersona(): void {
    this.personaService()
      ...
      .then(() => {
        const message = this.$t('crewApp.persona.deleted', { param: this.removeId });
