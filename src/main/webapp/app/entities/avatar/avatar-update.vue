    ...
    <div class="col-md-9">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div class="form-group">
          <b-form-checkbox v-model="avatar.human" switch size="lg">{{ $t('crewApp.avatar.isHuman') }}</b-form-checkbox>
        </div>
        ...
        <div v-show="avatar.human">
          <div class="form-group">
            <b-form-checkbox v-model="$v.avatar.circle.$model" switch size="lg">{{ $t('crewApp.avatar.isCircle') }}</b-form-checkbox>
          </div>
