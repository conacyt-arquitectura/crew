        ...
        <div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              name="nombre"
              id="badge-nombre"
              :class="{ valid: !$v.badge.nombre.$invalid, invalid: $v.badge.nombre.$invalid }"
              v-model="$v.badge.nombre.$model"
              required
            />
          ...
          <div class="form-group">
            ...
            <textarea
              class="form-control"
              name="descripcion"
              id="badge-descripcion"
              :class="{ valid: !$v.badge.descripcion.$invalid, invalid: $v.badge.descripcion.$invalid }"
              v-model="$v.badge.descripcion.$model"
              required
            ></textarea>
          ...
          <div class="form-group">
            ...
            <div>
              <img
                v-bind:src="'data:' + badge.logoContentType + ';base64,' + badge.logo"
              ...
              <input
                ...
                ref="file_logo"
                id="file_logo"
                v-on:change="setFileData($event, badge, 'logo', true)"
                accept="image/*"
            ...
            <input
              ...
              name="logo"
              id="badge-logo"
              :class="{ valid: !$v.badge.logo.$invalid, invalid: $v.badge.logo.$invalid }"
              v-model="$v.badge.logo.$model"
            />
            <input type="hidden" class="form-control" name="logoContentType" id="badge-logoContentType" v-model="badge.logoContentType" />
          </div>
        </div>
        <div>
